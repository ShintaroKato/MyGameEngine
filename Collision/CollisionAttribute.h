...
const unsigned short COLLISION_ATTR_OBJECT_SENSOR = (0b1 << 2) + 0b11;//ステージオブジェクト(攻撃型が持つ、敵を検知する範囲)
...
const unsigned short COLLISION_ATTR_BULLET = COLLISION_ATTR_WEAPONS + 0b1;//弾